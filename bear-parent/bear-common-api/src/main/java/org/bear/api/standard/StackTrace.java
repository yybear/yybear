...
public class StackTrace extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.bear.api.standard.StackTrace.Builder newBuilder() {
    return new org.bear.api.standard.StackTrace.Builder();
  }
  
  /** Creates a new StackTrace RecordBuilder by copying an existing Builder */
  public static org.bear.api.standard.StackTrace.Builder newBuilder(org.bear.api.standard.StackTrace.Builder other) {
    return new org.bear.api.standard.StackTrace.Builder(other);
  }
  
  /** Creates a new StackTrace RecordBuilder by copying an existing StackTrace instance */
  public static org.bear.api.standard.StackTrace.Builder newBuilder(org.bear.api.standard.StackTrace other) {
    return new org.bear.api.standard.StackTrace.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StackTrace>
    ...
    private Builder() {
      super(org.bear.api.standard.StackTrace.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.bear.api.standard.StackTrace.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing StackTrace instance */
    private Builder(org.bear.api.standard.StackTrace other) {
            super(org.bear.api.standard.StackTrace.SCHEMA$);
    ...
    /** Sets the value of the 'className' field */
    public org.bear.api.standard.StackTrace.Builder setClassName(java.lang.String value) {
    ...
    public org.bear.api.standard.StackTrace.Builder clearClassName() {
      className = null;
    ...
    /** Sets the value of the 'methodName' field */
    public org.bear.api.standard.StackTrace.Builder setMethodName(java.lang.String value) {
    ...
    public org.bear.api.standard.StackTrace.Builder clearMethodName() {
      methodName = null;
    ...
    /** Sets the value of the 'fileName' field */
    public org.bear.api.standard.StackTrace.Builder setFileName(java.lang.String value) {
    ...
    public org.bear.api.standard.StackTrace.Builder clearFileName() {
      fileName = null;
    ...
    /** Sets the value of the 'lineNumber' field */
    public org.bear.api.standard.StackTrace.Builder setLineNumber(int value) {
    ...
    public org.bear.api.standard.StackTrace.Builder clearLineNumber() {
