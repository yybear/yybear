    ...
    Autocomplete.prototype = {
        ...
        getSuggestions:function (q) {
            ...
            if (cr && $.isArray(cr.suggestions)) {
                ...
                $.get(this.serviceUrl, me.options.params, function (json) {
        ...
        suggest:function () {
            ...
            for (i = 0; i < len; i++) {
                ...
                div = $((me.selectedIndex === i ? '<div class="selected"' : '<div') + ' title="' + this.getTitle(s) + '">' + f(s, this.data[i], v) + '</div>');
        ...
        adjustScroll:function (i) {
            ...
            this.el.val(this.getTitle(this.suggestions[i]));
        },
